function [ object, range, anthroReference ] = grasp01_LargeDiameter( hand )
%UNTITLED15 Summary of this function goes here
%   This function test a hand ability to perform the Large Diameter grasp
%       Input   :: hand model
%       Output  :: 
%
%   Object for this grasp is a Cylinder with 11cm diameter
...
%Import object
[object.faces, object.vertices, object.normals] = stlread('objectModels\Cylinder_110dX250l_92faces.stl');
...
%   digits, therefore;  Xmin < palmXmax - objectXmax
%                       Xmax = palmXmax
range(1,1) = max(hand.palm.root.collisionMesh.vertices(:,1)) - 60;
range(1,2) = max(hand.palm.root.collisionMesh.vertices(:,1)) - 50;
...
range(3,1) = min(hand.palm.root.collisionMesh.vertices(hand.palm.root.collisionMesh.vertices(:,3)>0,3)) + 54;
range(3,2) = max(hand.palm.root.collisionMesh.vertices(:,3)) + 56;
%   Rotation;
...
% Test hand
%[ Qbest, qObjectBest, qHandBest] = handTestRand1( hand, object, range, anthroReference, 50 );
