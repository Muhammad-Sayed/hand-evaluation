function [ object, range, anthroReference ] = grasp03_MediumWrap( hand )
%UNTITLED15 Summary of this function goes here
%   This function test a hand ability to perform the Medium Wrap grasp
%       Input   :: hand model
%       Output  :: 
%
...
range(1,1) = max(hand.palm.root.collisionMesh.vertices(:,1)) - 20;
