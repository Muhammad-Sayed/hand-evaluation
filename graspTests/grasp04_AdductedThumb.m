function [ object, range, anthroReference ] = grasp04_AdductedThumb( hand )
%UNTITLED15 Summary of this function goes here
%   This function test a hand ability to perform the Adducted Thumb grasp
%       Input   :: hand model
%       Output  :: 
%
%   Object for this grasp is a Cylinder with 3cm diameter
...
%   digits and thumb, therefore;    Xmin = thumbBaseX
%                                   Xmax > palmXmax - objectDiameter
range(1,1) = digitBaseX(hand, 1);
range(1,2) = max(hand.palm.root.collisionMesh.vertices(:,1)) - 10;
...
range(4,1) = 88;
range(4,2) = 92;
%   The cylinder's longtuidnal axis is inclined with respect to the hand's
%   transverse plane by about 45 degrees, therefore the object should be 
%   rotated about Y axis with with similar angle and a very little margine
range(5,1) = 40;
range(5,2) = 50;
