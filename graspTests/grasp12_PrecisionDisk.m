function [ object, range, anthroReference ] = grasp12_PrecisionDisk( hand )
...
% Import object; CD
[object.faces, object.vertices, object.normals] = stlread('objectModels\Cylinder_120dX1.2l_96faces_CD.stl');
...
%   Z
range(3,1) = max(hand.palm.root.collisionMesh.vertices(:,3)) + 11;
