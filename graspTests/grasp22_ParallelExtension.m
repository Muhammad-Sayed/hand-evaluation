function [ object, range, anthroReference ] = grasp22_ParallelExtension( hand )
...
%Import object; Box 4cm thick
[object.faces, object.vertices, object.normals] = stlread('objectModels\Box_150X150X40_12faces.stl');
...
%   Z
range(3,1) = max(hand.palm.root.collisionMesh.vertices(:,3)) + 85;
