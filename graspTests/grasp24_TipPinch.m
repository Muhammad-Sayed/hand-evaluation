function [ object, range, anthroReference ] = grasp24_TipPinch( hand )
...
% Import object; 5mm Cube
[object.faces, object.vertices, object.normals] = stlread('objectModels\Box_5X5X5_12faces.stl');

% Calculate object pose range
%   Transition;
%   X
range(1,1) = max(hand.palm.root.collisionMesh.vertices(:,1)) / 2;
range(1,2) = digitBaseX(hand, 1) + digitLength(hand, 1);
%   Y
...
%   Z
range(3,1) = max(hand.palm.root.collisionMesh.vertices(:,3));
