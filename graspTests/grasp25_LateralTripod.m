function [ object, range, anthroReference ] = grasp25_LateralTripod( hand )
...
anthroReference.VF2             = bi2de([1 1 0 0]); % eception ; count index in VF2 because it is in contact
...
%Import object; Bottle Cap
[object.faces, object.vertices, object.normals] = stlread('objectModels\Cylinder_28dX12l_96faces_bottleCap.stl');
...
%   Z
range(3,1) = max(hand.palm.root.collisionMesh.vertices(:,3)) + 24;
