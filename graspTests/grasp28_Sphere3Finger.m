function [ object, range, anthroReference ] = grasp28_Sphere3Finger( hand )
...
anthroReference.VF2             = bi2de([1 1 0 0]);
...
%   Z
range(3,1) = min(hand.palm.root.collisionMesh.vertices(hand.palm.root.collisionMesh.vertices(:,3)>0,3)) + 34;
range(3,2) = max(hand.palm.root.collisionMesh.vertices(:,3)) + 54;
%   Rotation;
%   X
range(4,1) = 0;
range(4,2) = 0;
