function [ object, range, anthroReference ] = grasp30_Palmar( hand )
...
%   Transition;
%   X
range(1,1) = max(hand.palm.root.collisionMesh.vertices(:,1)) - 80;
range(1,2) = max(hand.palm.root.collisionMesh.vertices(:,1)) - 90;
%   Y
